...
public class AgregarServicio extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if(codigo.isEmpty() || nombre.isEmpty() || descripcion.isEmpty() || precio.isEmpty()){
            helper.showError("Todos los campos tiene que estar completos");
            return;
        }
        
        if(mg.isNumber(precio) != true){
            helper.showError("El precio tiene que ser un valor numerico");
            return;
        }
        
        if(getPrimaryKey().contains(codigo)){
            helper.showError("La codigo del servicio, ya existe");
            return;
        }
        
        sc.agregarServicio(codigo, nombre, descripcion, Double.parseDouble(precio));
        helper.showInformation("Se agrego un nuevo servicio");
    ...
    private List<String> getPrimaryKey(){
        ...
        List<String> clavesPrimarias = new ArrayList<>();
        
        for(Servicio i: servicios){
            clavesPrimarias.add(i.getCodigoServicio());
        }
